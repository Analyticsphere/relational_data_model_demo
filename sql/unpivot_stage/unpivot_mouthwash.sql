...
DELETE FROM `nih-nci-dceg-connect-stg-5519.relational.responses` WHERE source_table = 'CleanConnect.mouthwash';
...
FROM (
  SELECT Connect_ID,
    ...
    `d_957305523`,
    `d_983043203`
  FROM `nih-nci-dceg-connect-stg-5519.CleanConnect.mouthwash`
) t
